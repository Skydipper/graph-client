...
describe('GET similar dataset by id including descendent', () => {
    before(async () => {
    ...
    it('Getting similar datasets by id including descendent with dataset ids should return a 200 (happy case)', async () => {
        const records = [
            {
                keys: [
                    'dataset',
