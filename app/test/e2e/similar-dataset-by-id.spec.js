...
describe('GET similar dataset by id', () => {
    before(async () => {
    ...
    it('Getting similar datasets by id with dataset ids should return a 200 (happy case)', async () => {
        const records = [
            {
                keys: [
                    'd2.id',
        ...
        const response = await requester
            .get('/api/v1/graph/query/similar-dataset/e7b9efb2-3836-45ae-8b6a-f8391c7bcd2f');
    ...
    it('Getting similar datasets by id with dataset ids should return a 200 (happy case) - filtered by env', async () => {
        const records = [
            {
                keys: [
                    'd2.id',
